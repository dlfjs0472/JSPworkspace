...
function printCommentsList(json){ //js는 자료형이 존재하지않음(자바랑 틀림)
	...
	for(var i=0; i<json.commentsList.length; i++){
		...
		tag+="<div>";
		tag+="<input type=\"text\" value=\""+comments.msg+"\" style=\"width:70%\" readonly>";
		tag+="<input type=\"text\" value=\""+comments.cwriter+"\" style=\"width:10%\" readonly>";
	...
	var tag="";
	tag+="<div>";
	tag+="<input type=\"text\" value=\"댓글 메시지..\" style=\"width:70%\" readonly>";
	tag+="<input type=\"text\" value=\"작성자\" style=\"width:10%\" readonly>";
...
//댓글 목록 출력하기(방법2 : 출력 대상이 되는 태그를 객체로 처리하는법)
