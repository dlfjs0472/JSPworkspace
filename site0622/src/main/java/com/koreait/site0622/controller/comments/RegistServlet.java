...
//댓글 등록 요청처리 서블릿(클라리언트의 요청이 비동기방식이므로, 디자인을 결과로 보내서는 안됨!! 처리결과만..
//왜? 전체 새로고침이 일어나지 않는 방식이라 디자인을 보낼 의미가 없음, 즉 전체페이지 변환이 목적이 아니라,
//페이지의 일부의 변경이 목적임..)
public class RegistServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//DAO에게 일 시키기
		int result=commentsDAO.insert(comments); //mybatisCommentsDAO 로써 일을 한다 polymorphism(다형성)
