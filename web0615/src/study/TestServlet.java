...
public class TestServlet extends HttpServlet{
	...
	//node.js와 마찬가지로 클라이언트으 ㅣ요청을 처리하려면, 어떤 요청정보를 가지고 클라이언트가
	//요청했는지에 대한 정보를 가진, 요청객체를 이용해야한다!!
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		response.setCharacterEncoding("utf-8");//스트림을 뽑기 전에 미리 인코딩 처리
		
		PrintWriter out =response.getWriter(); //문자기반의 출력스트림을 반환하는 메서드!!
